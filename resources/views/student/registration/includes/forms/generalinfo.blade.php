...
<div class="form-group">
    ...
    {!! Form::label('university_reg', 'COLLEGE REG. NO.', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-2">
...
<div class="form-group">
    ...
    {!! Form::label('state', 'District', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-3">
...
<div class="form-group">
    ...
    {!! Form::label('temp_state', 'District', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-3">
